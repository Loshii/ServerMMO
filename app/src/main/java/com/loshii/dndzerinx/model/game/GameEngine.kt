...
sealed interface GameEvent {
    data class MonsterDamaged(val monsterId: String, val damage: Int, val isCrit: Boolean) : GameEvent
    data class PlayerDamaged(val damage: Int, val currentHp: Int) : GameEvent
    data class MonsterKilled(val monsterId: String, val xpReward: Int, val goldReward: Int) : GameEvent
